...
FIELD__DEFAULT_PROPERTY = {
    ...
    T_DTLS_REC_CONTENT_TYPE: {"FL": 8,  "TYPE": int, "ALGO": "DIRECT"},
    T_DTLS_REC_VERSION     : {"FL": 16, "TYPE": int, "ALGO": "DIRECT"},
    T_DTLS_REC_EPOCH       : {"FL": 16, "TYPE": int, "ALGO": "DIRECT"},
    T_DTLS_REC_SEQ         : {"FL": 48, "TYPE": int, "ALGO": "DIRECT"},
    T_DTLS_REC_LEN         : {"FL": 16, "TYPE": int, "ALGO": "DIRECT"},
    T_DTLS_HS_TYPE         : {"FL": 8, "TYPE": int, "ALGO": "DIRECT"},
    T_DTLS_HS_LEN          : {"FL": 24, "TYPE": int, "ALGO": "DIRECT"},
    T_DTLS_HS_MSG_SEQ      : {"FL": 16, "TYPE": int, "ALGO": "DIRECT"},
    T_DTLS_HS_FRAG_OFFSET  : {"FL": 24, "TYPE": int, "ALGO": "DIRECT"},
    T_DTLS_HS_FRAG_LEN     : {"FL": 24, "TYPE": int, "ALGO": "DIRECT"},
    T_DTLS_HS_CH_VERSION   : {"FL": 16, "TYPE": int, "ALGO": "DIRECT"},
    T_DTLS_HS_CH_RANDOM    : {"FL": 256, "TYPE": bytes, "ALGO": "DIRECT"},
    T_DTLS_HS_CH_SESSION_ID: {"FL": "var", "TYPE": bytes, "ALGO": "DIRECT"},
    T_DTLS_HS_CH_COOKIE    : {"FL": "var", "TYPE": bytes, "ALGO": "DIRECT"},
    T_DTLS_HS_CH_CIPHER_SUITES:{"FL": "var", "TYPE": bytes, "ALGO": "DIRECT"},
    T_DTLS_HS_CH_COMP_METHODS:{"FL": "var", "TYPE": bytes, "ALGO": "DIRECT"},
    T_DTLS_HS_CH_EXTS      : {"FL": "var", "TYPE": bytes, "ALGO": "DIRECT"},
    T_DTLS_HS_SH_VERSION   : {"FL": 16, "TYPE": int, "ALGO": "DIRECT"},
    T_DTLS_HS_SH_RANDOM    : {"FL": 256, "TYPE": bytes, "ALGO": "DIRECT"},
    T_DTLS_HS_SH_SESSION_ID: {"FL": "var", "TYPE": bytes, "ALGO": "DIRECT"},
    T_DTLS_HS_SH_CIPHER_SUITE:{"FL": 16, "TYPE": int, "ALGO": "DIRECT"},
    T_DTLS_HS_SH_COMP_METHOD:{"FL": 8, "TYPE": int, "ALGO": "DIRECT"},
    T_DTLS_HS_SH_EXTS      : {"FL": "var", "TYPE": bytes, "ALGO": "DIRECT"},
    T_DTLS_HS_SVR_VERSION  : {"FL": 16, "TYPE": int, "ALGO": "DIRECT"},
    T_DTLS_HS_SVR_COOKIE   : {"FL": "var", "TYPE": bytes, "ALGO": "DIRECT"},
    T_DTLS_HS_CKE_IDENTITY : {"FL": "var", "TYPE": bytes, "ALGO": "DIRECT"},
    T_DTLS_CHANGE_CIPHER_SPEC:{"FL": 8, "TYPE": int, "ALGO": "DIRECT"},
    ...
    T_COAP_OPT_OSCORE_FLAGS: {"FL": "var", "TYPE": int, "ALGO": "COAP_OPTION"},
    T_COAP_OPT_OSCORE_PIV  : {"FL": "var", "TYPE": bytes, "ALGO": "COAP_OPTION"},
    T_COAP_OPT_OSCORE_KIDCTX:{"FL": "var", "TYPE": bytes, "ALGO": "COAP_OPTION"},
    T_COAP_OPT_OSCORE_KID:   {"FL": "var", "TYPE": bytes, "ALGO": "COAP_OPTION"},
    ...
    T_COAP_OPT_PROXY_SCHEME: {"FL": "var", "TYPE": str, "ALGO": "COAP_OPTION" },
